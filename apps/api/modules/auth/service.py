...
from apps.api.core.models import User, UserRole, AuditLog
from apps.api.core.ports import EmailPort, EventBusPort
from apps.api.modules.auth.schemas import UserCreate
...
class AuthService:
    ...
    def create_user(self, user: UserCreate):
        ...
        # Audit Log
        from apps.api.core.models import AuditLog
