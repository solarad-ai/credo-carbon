...
interface Query {
    id: number;
    validation_task_id: number | null;
...
export default function VVBQueriesPage() {
    ...
    const fetchQueries = async () => {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/vvb/queries`, {
                headers: {
    ...
    const handleResolve = async (queryId: number) => {
        try {
            const token = localStorage.getItem("access_token");
            const response = await fetch(`${API_BASE_URL}/api/vvb/queries/${queryId}/resolve`, {
                method: "PUT",
                headers: {
                    Authorization: `Bearer ${token}`,
                },
                ...
                <Card className="border-slate-200 dark:border-slate-700">
                    <CardContent className="p-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-sm text-slate-500">Open Queries</p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    <Button
                        ...
                        className={filterStatus === "OPEN" ? "bg-emerald-600 hover:bg-emerald-700" : ""}
                    >
                        Open
                    </Button>
                    <Button
                        ...
                        className={filterStatus === "RESPONDED" ? "bg-emerald-600 hover:bg-emerald-700" : ""}
                    >
                        Responded
                    </Button>
                    <Button
                        ...
                        className={filterStatus === "RESOLVED" ? "bg-emerald-600 hover:bg-emerald-700" : ""}
                    >
                        Resolved
                    </Button>
                </div>
                                ...
                                <div className="flex items-start justify-between gap-4">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-3 mb-2">
                                            ...
                                            <Badge className={statusColors[query.status] || statusColors.OPEN}>
                                                {query.status}
                                            </Badge>
                                        </div>
