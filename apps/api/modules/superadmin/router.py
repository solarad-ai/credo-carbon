...
from apps.api.modules.superadmin.dependencies import get_current_superadmin
from apps.api.modules.superadmin.service import SuperAdminService
...
def create_vvb_user(
    ...
    from apps.api.modules.auth.service import AuthService, get_password_hash
    from apps.api.core.models import UserRole
...
def assign_project_to_vvb(
    ...
    from apps.api.core.models import Project, UserRole
    from apps.api.modules.vvb.models import ValidationTask, VerificationTask
...
def assign_project_to_registry(
    ...
    from apps.api.core.models import Project, UserRole
    from apps.api.modules.registry.models import RegistryReview
