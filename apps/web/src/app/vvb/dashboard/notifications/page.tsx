...
export default function VVBNotificationsPage() {
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400">
                        Stay updated with your validation and verification tasks
                    </p>
                </div>
                {unreadCount > 0 && (
                    <Button
                    ...
                    filteredNotifications.map((notification) => (
                        <Card
                            ...
                            className={`border-slate-200 dark:border-slate-700 transition-all ${!notification.is_read
                                ? "bg-emerald-50/50 dark:bg-emerald-900/10 border-l-4 border-l-emerald-500"
                                : ""
                                }`}
                        >
